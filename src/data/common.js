...
export const faq = [
  {
    ...
    desc: "ContentDetector.AI can identify any AI-generated text, including GPT 3 content. ContentDetector.AI is trained on GPT 3 output, it can detect the GPT 3 content accurately.",
  },
  {
    id: 2,
    title: "GPT 4 Content Detector",
    desc: "ContentDetector.AI can identify any AI-generated text, including GPT 4 content. Even if GPT 4 is the next version of generative AI technology that ContentDetector.AI is trained on this, it can detect the GPT 4 content fairly accurately.",
  },
  {
    id: 3,
    title: "ChatGPT Content Detector",
    desc: "ChatGPT works on GPT 3.5 and GPT 4. Even if GPT 3 and GPT 4is the next version of generative AI technology that ContentDetector.AI is trained on, from our testing, it detects the ChatGPT-generated content with reasonable accuracy. We are constantly working hard to improve the tool.",
  },
  {
    id: 4,
    title: "Jasper Al Content Detector",
  ...
  {
    id: 5,
    title: "Can It Detect Al Content from Other Tools such as Copy.Al",
